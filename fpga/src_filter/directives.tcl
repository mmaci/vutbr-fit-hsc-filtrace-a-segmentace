...
directive set -TECHLIBS {{mgc_Xilinx-SPARTAN3-4_beh_psr.lib {{mgc_Xilinx-SPARTAN3-4_beh_psr part 3s50tq144}}} {ram_Xilinx-SPARTAN3-4_RAMSB.lib ram_Xilinx-SPARTAN3-4_RAMSB}}
go compile
directive set /filter/core/main -PIPELINE_INIT_INTERVAL 1
